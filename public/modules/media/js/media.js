...
Component.options.__file = "modules/media/resources/assets/js/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-003a781d", Component.options)
  } else {
    hotAPI.reload("data-v-003a781d", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_semantic_ui_vue__ = __webpack_require__(52);
...
Vue.component('index', __webpack_require__(4).default);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Modal__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_index_css__ = __webpack_require__(45);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mounted: function mounted() {
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('http://127.0.0.1:8000/media/data').then(function (res) {
...
/* scopeId */
var __vue_scopeId__ = "data-v-ef90814e"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "modules/media/resources/assets/js/components/Modal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ef90814e", Component.options)
  } else {
    hotAPI.reload("data-v-ef90814e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(38)("629021fe", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ef90814e\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Modal.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ef90814e\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Modal.vue");
...
// module
exports.push([module.i, "\ni.icon[data-v-ef90814e] {\n  height: auto !important;\n}\n.ui.progress[data-v-ef90814e]:last-child {\n  margin-bottom: 0 !important;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_modal_css__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_modal_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__css_modal_css__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  name: 'Modal',
  methods: {
    inputChangeName: function inputChangeName(f) {
      f.uploadError = false;
      f.status = 'ready';
    },
    ...
    onFileChange: function onFileChange(e) {
      ...
      for (i = 0; i < e.target.files.length; i++) {
        var fileAttr = e.target.files[i];
        var fileSrc = URL.createObjectURL(e.target.files[i]);
        var fileNameFetched = e.target.files[i].name;
        var fileNameFetchedOnly = fileNameFetched.substr(0, fileNameFetched.lastIndexOf('.'));
        var fileName = fileNameFetchedOnly;
        var status = 'ready';
        var uploadPercentage = 0;
        var uploadResult = null;
        var uploadError = false;
        var fileInputName = null;
        this.file.push({
          fileAttr: fileAttr,
          fileSrc: fileSrc,
          fileName: fileName,
    ...
    uploadSingle: function uploadSingle(f) {
      ...
      formData.append('fileName', f.fileInputName ? f.fileInputName : f.fileName);
      var config = {
      ...
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('http://127.0.0.1:8000/media', formData, config).then(this.uploading = true).then(function (response) {
...
// module
exports.push([module.i, ".my-modal {\n  top: 0;\n  bottom: 0;\n  right: 0;\n  left: 0;\n  position: fixed;\n  background-color: rgba(0, 0, 0, 0.5);\n  z-index: 1100 !important;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n\n.my-modal .my-modal-content {\n  height: 70%;\n  width: 70%;\n  border-radius: 10px;\n  background-color: #f5f5f5;\n}\n\n.my-modal .my-modal-content .my-modal-header {\n  height: 15%;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: start;\n      -ms-flex-pack: start;\n          justify-content: flex-start;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n\n.my-modal .my-modal-content .my-modal-header h1 {\n  font-weight: 400;\n  margin-left: 1rem;\n}\n\n.my-modal .my-modal-content .my-modal-row {\n  height: 65%;\n  border-top: 1px solid rgba(0, 0, 0, 0.2);\n  border-bottom: 1px solid rgba(0, 0, 0, 0.2);\n  padding: 1rem;\n  overflow-y: scroll;\n}\n\n.my-modal .my-modal-content .my-modal-row .single-row {\n  width: 60%;\n  height: 100px;\n  margin: auto;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-pack: distribute;\n      justify-content: space-around;\n  background-color: #e9e9e9;\n  margin: 1rem auto;\n}\n\n.my-modal .my-modal-content .my-modal-row .single-row .img {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n\n.my-modal .my-modal-content .my-modal-row .single-row .img img {\n  height: 80px;\n}\n\n.my-modal .my-modal-content .my-modal-row .single-row .input {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: column;\n          flex-direction: column;\n  -ms-flex-pack: distribute;\n      justify-content: space-around;\n  padding: 0.4rem 0;\n}\n\n.my-modal .my-modal-content .my-modal-row .single-row .actions {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-pack: distribute;\n      justify-content: space-around;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n\n.my-modal .my-modal-content .my-modal-row .single-row .actions i {\n  font-size: 30px;\n  margin: 0 0.5rem;\n  cursor: pointer !important;\n}\n\n.my-modal .my-modal-content .my-modal-row .single-row .actions i i.icon {\n  height: 0 !important;\n}\n\n.my-modal .my-modal-content .my-modal-actions {\n  height: 20%;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: start;\n      -ms-flex-pack: start;\n          justify-content: flex-start;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  margin-left: 1rem;\n}\n\n.my-modal .my-modal-content .my-modal-actions button {\n  margin: 0.5rem;\n}\n\n.my-modal .my-modal-content .my-modal-actions label {\n  cursor: pointer;\n  margin-bottom: 0px !important;\n}\n\n.my-modal .my-modal-content .my-modal-actions .add {\n  pointer-events: none;\n}\n\n.my-modal .my-modal-content .my-modal-actions input {\n  display: none;\n  opacity: 0;\n}", ""]);
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "my-modal-content" }, [
        ...
        _c(
          "div",
          { staticClass: "my-modal-row" },
          _vm._l(_vm.file, function(f, index) {
            return _c("div", { key: "f-" + index, staticClass: "single-row" }, [
              _c("div", { staticClass: "img" }, [
                _c("img", { attrs: { src: f.fileSrc, alt: "" } })
              ]),
              _vm._v(" "),
              _c(
                "div",
                ...
                [
                  _c("sui-input", {
                    attrs: { placeholder: f.fileName, error: f.uploadError },
                    on: {
                      keydown: function($event) {
                        return _vm.inputChangeName(f)
                      }
                    },
                    model: {
                      value: f.fileInputName,
                      callback: function($$v) {
                        _vm.$set(f, "fileInputName", $$v)
                      },
                      expression: "f.fileInputName"
                    }
                  }),
                  _vm._v(" "),
                  f.status === "ready"
                    ...
                    : _c("p", [_vm._v("Failed, change the image name")])
                ],
                1
              ),
              _vm._v(" "),
        ...
        _c(
          ...
          [
            _c(
              "label",
              {
                staticStyle: { margin: "none !important" },
                attrs: { for: "input-file" }
              },
              [
                _c(
                  "sui-button",
                  { staticClass: "add", attrs: { positive: "" } },
                  [_vm._v("Add Files")]
                )
              ],
              1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ef90814e", module.exports)
  }
}
  ...
  return _c(
    ...
    [
                ...
                [
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("sui-table-header-cell", [_vm._v("Size")]),
                      _vm._v(" "),
              ...
              _c(
                ...
                [
                  _c(
                    "sui-table-row",
                    [
                      _c("sui-table-cell", [_vm._v("1")]),
                      _vm._v(" "),
                      _c("sui-table-cell", [_vm._v("John Cena")]),
                      _vm._v(" "),
                      _c("sui-table-cell", { staticClass: "td-table-image" }, [
                        _c("img", {
                          staticClass: "table-image",
                          attrs: { src: "storage/uploads/anggur.jpg", alt: "" }
                        })
                      ]),
                      _vm._v(" "),
                      _c("sui-table-cell", [_vm._v("10")]),
                      _vm._v(" "),
                      _c("sui-table-cell", [_vm._v("12972")]),
                      _vm._v(" "),
                      _c("sui-table-cell", [_vm._v("Admin")]),
                      _vm._v(" "),
                      _c("sui-table-cell", [_vm._v("Null")]),
                      _vm._v(" "),
                      _c("sui-table-cell", [_vm._v("johncena.jpg")]),
                      _vm._v(" "),
                      _c(
                        "sui-table-cell",
                        [
      ...
      _c(
        "div",
        { staticClass: "footer" },
        [_c("sui-button", { attrs: { primary: "" } }, [_vm._v("Primary")])],
        1
      )
    ],
    1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-003a781d", module.exports)
  }
}
